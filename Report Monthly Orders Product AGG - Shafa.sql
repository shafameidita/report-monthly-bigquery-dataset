...
4. SELECT 
  ...
  o.created_at, 
  o.sale_price
   - Pada tahap ini saya memilih kolom-kolom dengan nama diatas dari berbagai tabel yang tersedia (contoh: o.order_id adalah kolom order_id pada tabel order_items) 
   - saya juga menggabungkan kolom (CONCAT) kolom first_name dan last_name dan memberi nama kolom tersebut sebagai kolom user_name yang diakses dari tabel u (users)
5. saya melakukan join pada tabel products dan tabel users ke tabel order_items 
...
6. saya melakukan hal yang sama juga antara tabel users dan tabel order_items
7. WHERE : ini merupakan tahap filtering
8. status like 'Complete' : saya mau hanya menampilkan data dengan status Complete
9. AND o.created_at BETWEEN '2024-07-01' AND '2024-07-31'; : dan saya hanya mau menampilkan pada data bulan Juli 2024
